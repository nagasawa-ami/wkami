    ...
    <div Class="result__content">
        <div class="result-cards">
            <div class="result-card">
                <div class="result-card___img-wrapper">
                    <img class="result-card___img" src="img/<?php echo $tokyo['img']?>" alt="国旗">
                </div>
            ...
            <div class="result-card">
                <div class="result-card___img-wrapper">
                    <img class="result-card___img" src="img/<?php echo $comparison['img']?>" alt="国旗">
                </div>
                <div class="result-card__body">
